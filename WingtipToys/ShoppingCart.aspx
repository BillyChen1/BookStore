...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="ShoppingCartTitle" runat="server" class="ContentHead"><h1>购物车</h1></div>
    ...
    <div>
        <p></p>
        <strong>
            <asp:Label ID="LabelTotalText" runat="server" Text="总价格: "></asp:Label>
    ...
    <tr>
      <td>
        <asp:Button ID="UpdateBtn" runat="server" Text="更新" OnClick="UpdateBtn_Click" class="btn btn-primary"/>
      </td>
      <td>
