...
public class NVPAPICaller
{
    ...
    //沙盒测试信息
    public string APIUsername = "sb-3iqtq2603169_api1.business.example.com";
    private string APIPassword = "YJ6BV4VBH7EYKECA";
    private string APISignature = "ACb9vut99j8KU2G14U9TkFjpZcjWAFxeJWIzmJ.cOuOMMJfsSIrykg-8";
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        //objRequest.ProtocolVersion = new Version(1, 0);
