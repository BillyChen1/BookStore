        ...
        <ItemTemplate>
            ...
            <table>
                <tr>
                    ...
                    <td>&nbsp;</td>  
                    <td style="vertical-align: top; text-align:left; padding: 25px 30px;">
                        <b>详情:</b><br /><%#:Item.Description %><br /><span><b>价格:</b>&nbsp;<%#: String.Format("{0:c}", Item.UnitPrice) %></span><br /><span><b>编号:</b>&nbsp;<%#:Item.ProductID %></span><br /></td>
                </tr>
            </table>
        </ItemTemplate>
    </asp:FormView>
